...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "MEGA_MAN_LEGENDS_PROJECT_ROOT",
    .build_dir_env = "MEGA_MAN_LEGENDS_BUILD_DIR",
    .force_setup_env = "MEGA_MAN_LEGENDS_FORCE_SETUP",
