# Mega Man Legends Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/mega-man-legends-recomp/total)](https://github.com/Alexbeav/mega-man-legends-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/mega-man-legends-recomp/latest/total)](https://github.com/Alexbeav/mega-man-legends-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/mega-man-legends-recomp)](https://github.com/Alexbeav/mega-man-legends-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Mega Man Legends** built on
...
Zip prefix for CI artifacts: `Mega-Man-Legends-Recomp`.
...
The `v0.3.4` source uses `Mega_Man_Legends_Recompiled` in CMake, the setup relaunch, and the packager.

Release `v0.3.4` accepts the canonical two-file Redump layout. It verifies the
