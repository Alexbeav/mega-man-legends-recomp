...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/TechnicallyComputers/Mega-Man-Legends/total)](https://github.com/TechnicallyComputers/Mega-Man-Legends/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/TechnicallyComputers/Mega-Man-Legends/latest/total)](https://github.com/TechnicallyComputers/Mega-Man-Legends/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/TechnicallyComputers/Mega-Man-Legends)](https://github.com/TechnicallyComputers/Mega-Man-Legends/releases/latest)
<!-- /retcomm-readme-metrics -->
...
Zip prefix for CI artifacts: `mml`.
