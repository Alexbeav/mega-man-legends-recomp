...
The supported serial set is `SLES-01485`. The package uses
...
The corrected source uses `Mega_Man_Legends_Recompiled` for CMake, the setup relaunch, and packaging.
