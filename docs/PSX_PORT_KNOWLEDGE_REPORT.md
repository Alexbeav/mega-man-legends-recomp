# Mega Man Legends knowledge report

- Date: 2026-09-02
- Retail identity: Europe PAL `SLES-01485`
...
The source now uses `Mega_Man_Legends_Recompiled` as the only setup executable name. The batch source
